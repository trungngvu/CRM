...
const ProjectManagerTitle = ({
...
}: ProjectManagerTitleProps) => {
  const translate = useI18n({
    name: ProjectManagerTitle.name,
    data: [
      {
        key: LANGUAGES.EN,
        value: en,
  ...
  return (
    <div className="p-4 bg-white border rounded border-secondary">
      ...
      <div
        className="pb-4 mb-4 border-b-2 ck-content"
...
export default ProjectManagerTitle;
